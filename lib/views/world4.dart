...
class World4Page extends StatelessWidget {
  ...
  Future<Map<int, List<FriendInfo>>> _loadFriendsProgress(
    ...
    for (var doc in friends) {
      ...
      // Check if friend has completed all levels in world 3
      bool hasUnlockedWorld = true;  // Start true, set to false if any level is incomplete
      for (int i = 0; i < 10; i++) {
        String key = '2-$i';  // Check each level in world 3
      ...
      if (!hasUnlockedWorld) {
        print('Friend $friendName has not completed all levels in world 3');
        continue;  // Skip this friend if they haven't completed world 3
      }
      ...
      print('Friend $friendName is at level $highestLevel in world 4');
    ...
    print('Friends by level in world 4: $friendsByLevel');
